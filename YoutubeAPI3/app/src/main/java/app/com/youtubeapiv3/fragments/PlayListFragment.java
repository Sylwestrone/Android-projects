...
public class PlayListFragment extends Fragment {
    ...
    private static String YOUTUBE_API_KEY = "AIzaSyAYJpJXGfsC6VBJhqaSg-QW5kgwvdH0Uhk";
    private static String PLAYLIST_ID = "PLh6vppUwmWEMdp04u-tYABoDmgn9AX12n";
    private static String CHANNEL_GET_URL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=" + PLAYLIST_ID + "&maxResults=20&key=" + YOUTUBE_API_KEY + "";
